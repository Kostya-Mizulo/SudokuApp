...
## Правила:
 ...
 - **BLoC-архитектура** — ОБЯЗАТЕЛЬНА. Виджеты сами не меняют своё состояние. Виджеты отправляют ивенты в блок, блок выполняет бизнес-логику и стримит изменения, виджеты слушают стрим своего блока и меняют своё состояние при необходимости.